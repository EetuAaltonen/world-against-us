function ListDrawAvailableInstance(_position, _size, _availableInstance)
{
	var outlineWidth = 2;
	draw_sprite_ext(
		sprGUIBg, 0,
	...
	draw_text(_position.X + _size.w - 10, _position.Y + (_size.h * 0.5), string("{0} players", _availableInstance.player_count));
