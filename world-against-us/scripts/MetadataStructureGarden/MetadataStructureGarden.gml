...
{	
	tools_inventory = new Inventory("GardenBedTools", INVENTORY_TYPE.Garden, { columns: 2, rows: 2 }, ["Garden Tools"]);
	fertilizer_inventory = new Inventory("GardenBedFertilizer", INVENTORY_TYPE.Garden, { columns: 2, rows: 3 }, ["Fertilizer Sack"]);
	water_inventory = new Inventory("GardenBedWater", INVENTORY_TYPE.Garden, { columns: 2, rows: 3 }, ["Watering Can"]);
	seed_inventory = new Inventory("GardenBedSeed", INVENTORY_TYPE.Garden, { columns: 1, rows: 1 }, ["Tomato Seed Pack"]);
	output_inventory = new Inventory("GardenBedOutput", INVENTORY_TYPE.Garden, { columns: 10, rows: 4 }, ["Consumable"]);
