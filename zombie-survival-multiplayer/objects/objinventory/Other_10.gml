		...
		if (gameSaveData.isSaveLoadingFirstTime)
		{
			...
			if (!is_undefined(saveDataBackpack))
			{
				...
				if (ds_list_size(inventory.items) <= 0)
				{
					...
					inventory.AddItem(global.ItemDatabase.GetItemByName("Fertilizer Sack"), undefined, false, true, true);
					inventory.AddItem(global.ItemDatabase.GetItemByName("Garden Tools"), undefined, false, true, true);
					inventory.AddItem(global.ItemDatabase.GetItemByName("Watering Can"), undefined, false, true, true);
					inventory.AddItem(global.ItemDatabase.GetItemByName("Tomato Seed Pack"), undefined, false, true, true);
		
					inventory.AddItem(global.ItemDatabase.GetItemByName("Nails", 60), undefined, false, true, true);
					inventory.AddItem(global.ItemDatabase.GetItemByName("Wooden Plank"), undefined, false, true, true);
					inventory.AddItem(global.ItemDatabase.GetItemByName("Wooden Plank"), undefined, false, true, true);
					inventory.AddItem(global.ItemDatabase.GetItemByName("Wooden Plank"), undefined, false, true, true);*/
				}
			}
